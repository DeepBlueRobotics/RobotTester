...
public class Robot extends TimedRobot {
  ...
  public static CopyOnWriteArrayList<Runnable> periodicFunctions = new CopyOnWriteArrayList<>();
  ...
  public void robotPeriodic() {
    ...
    periodicFunctions.forEach(Runnable::run);
  }

  public static void registerPeriodic(Runnable function) {
    periodicFunctions.add(function);
  }
